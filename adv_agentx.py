...
axl.snmp_set_var_typed_value.argtypes = [ctypes.POINTER(netsnmp_variable_list), ctypes.c_ubyte,
                                         ctypes.POINTER(ctypes.c_ubyte), ctypes.c_int]
axl.snprint_objid.argtypes = [strOID_t, ctypes.c_int, ctypes.POINTER(oid_t), ctypes.c_int]
axl.snmp_varlist_add_variable.argtypes = [ctypes.POINTER(netsnmp_variable_list_p), ctypes.POINTER(oid_t), ctypes.c_long,
                                          ctypes.c_ubyte, ctypes.c_char_p, ctypes.c_long]
...
class RequestObject(object):
    ...
    def SetValue(self, value):
        ...
        if type(value) == str:
            ...
            value = ctypes.pointer(ctypes.c_uint(value))
        try:
            axl.snmp_set_var_typed_value(self.__request.requestvb, otype,
